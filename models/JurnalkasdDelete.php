 ...
 * Page class
 */
class JurnalkasdDelete extends Jurnalkasd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JurnalkasdDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jurnalkasddelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jurnalkasdlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("jurnalkasdlist"); // Return to list
                return;
            }
        }
