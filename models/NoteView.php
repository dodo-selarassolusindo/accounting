...
class NoteView extends Note
{
    ...
    // CSS class/style
    public $CurrentPageName = "noteview";
    ...
    public function __construct()
    {
        ...
        // Set up record key
        if (($keyValue = Get("NoteID") ?? Route("NoteID")) !== null) {
            $this->RecKey["NoteID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("NoteID") ?? Route("NoteID")) !== null) {
            $this->NoteID->setQueryStringValue($keyValue);
            $this->RecKey["NoteID"] = $this->NoteID->QueryStringValue;
        } elseif (Post("NoteID") !== null) {
            $this->NoteID->setFormValue(Post("NoteID"));
            $this->RecKey["NoteID"] = $this->NoteID->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->NoteID->setQueryStringValue($keyValue);
            $this->RecKey["NoteID"] = $this->NoteID->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "notelist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("notelist"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->NoteID->CurrentValue, $this->CurrentRow['NoteID'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "notelist"; // No matching record, return to list
                    } else {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("notelist"), "", $this->TableVar, true);
        $pageId = "view";
