 ...
 * Page class
 */
class JurnalkasdGrid extends Jurnalkasd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JurnalkasdGrid";
    ...
    public $FormName = "fjurnalkasdgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "jurnalkasdgrid";
    ...
    protected function editRow()
    {
        ...
        // Check referential integrity for master table 'jurnalkas'
        $detailKeys = [];
        $keyValue = $rsnew['jurnal_id'] ?? $rsold['jurnal_id'];
        $detailKeys['jurnal_id'] = $keyValue;
        $masterTable = Container("jurnalkas");
        ...
        if (!$validMasterRecord) {
            $relatedRecordMsg = str_replace("%t", "jurnalkas", $Language->phrase("RelatedRecordRequired"));
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "jurnalkas") {
        ...
        // Check referential integrity for master table 'jurnalkasd'
