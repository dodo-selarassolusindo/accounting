 ...
 * Page class
 */
class JurnalkasdView extends Jurnalkasd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JurnalkasdView";
    ...
    // CSS class/style
    public $CurrentPageName = "jurnalkasdview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "jurnalkasdlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("jurnalkasdlist"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "jurnalkasdlist"; // No matching record, return to list
                    } else {
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jurnalkasdlist"), "", $this->TableVar, true);
        $pageId = "view";
