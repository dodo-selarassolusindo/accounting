 ...
 * Page class
 */
class JurnalkasDelete extends Jurnalkas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JurnalkasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jurnalkasdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jurnalkaslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("jurnalkaslist"); // Return to list
                return;
            }
        }
