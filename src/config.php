...
$CONFIG = [
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-purple", // CSS class(es) for sidebar
    ...
    "AES_ENCRYPTION_KEY" => "qxRV0cXjeh/vh300f4gthgI92XOUATRfhXX620iujB4=", // AES encryption key (base64 encoded)
    ...
    // Export Log
    "EXPORT_PATH" => "export-bf72de82-cb59-461f-848a-24cdfe0dcfe4", // Export folder
