...
$Page->showMessage();
?>
<form name="fjurnalkasadd" id="fjurnalkasadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<?php } else { ?>
<table id="tbl_jurnalkasadd" class="<?= $Page->TableClass ?>"><!-- table* -->
<?php } ?>
...
<script>
loadjs.ready(["fjurnalkasadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fjurnalkasadd", "x_createon", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<?php } ?>
<?php
    if (in_array("jurnalkasd", explode(",", $Page->getCurrentDetailTable())) && $jurnalkasd->DetailAdd) {
?>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fjurnalkasadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fjurnalkasadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
