...
$topMenu->addMenuItem(57, "mci_Akun", $Language->menuPhrase("57", "MenuText"), "", 24, "", true, false, true, "", "", true, false);
$topMenu->addMenuItem(3, "mi_grup", $Language->menuPhrase("3", "MenuText"), "gruplist", 57, "", true, false, false, "", "", true, false);
$topMenu->addMenuItem(19, "mi_subgrup", $Language->menuPhrase("19", "MenuText"), "subgruplist", 57, "", true, false, false, "", "", true, false);
$topMenu->addMenuItem(1, "mi_akun", $Language->menuPhrase("1", "MenuText"), "akunlist", 57, "", true, false, false, "", "", true, false);
...
$sideMenu->addMenuItem(57, "mci_Akun", $Language->menuPhrase("57", "MenuText"), "", 24, "", true, false, true, "", "", true, true);
$sideMenu->addMenuItem(3, "mi_grup", $Language->menuPhrase("3", "MenuText"), "gruplist", 57, "", true, false, false, "", "", true, true);
$sideMenu->addMenuItem(19, "mi_subgrup", $Language->menuPhrase("19", "MenuText"), "subgruplist", 57, "", true, false, false, "", "", true, true);
$sideMenu->addMenuItem(1, "mi_akun", $Language->menuPhrase("1", "MenuText"), "akunlist", 57, "", true, false, false, "", "", true, true);
